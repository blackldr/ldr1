...
os.system('espeak -a 300 " Welcome,   to,  Tamim,  Leader,  Tools"')
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mBlackLDR ]\33[1;38m     ║\033[1;31m 
╠══[Facebook                 • Tamim Ahamed Tamim ]   ║  \033[1;97m  
╠══[Github                   • \33[1;38mBLACK-LDR ]   ║\33[1;34m   
╠══[Whatsapp                 • 01980471227 ]  ║\33[1;35m 
╠══[TOOLS                    • Paid  ]        ║ \33[1;32m   
...
def login():
	...
	if TUTUL in ['m']:
		...
		os.system('xdg-open https://wa.me/+8801980471227')
	elif TUTUL in ['0']:
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				print('\033[0;94m==============================================================')
				os.system('espeak -a 300 " Tamim,  Ok,  id"')
